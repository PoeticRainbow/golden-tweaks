package io.github.poeticrainbow.goldentweaks.mixin.tweak.dirt_gui_background;
...
public abstract class ScreenMixin {
    ...
    private void goldentweaks$render_dirt_for_panorama(GuiGraphics guiGraphics, float f, Operation<Void> original) {
    ...
    private void goldentweaks$remove_menu_background(GuiGraphics guiGraphics, int i, int j, int k, int l, Operation<Void> original) {
        if (Tweaks.DIRT_GUI_BACKGROUND.get()) {
        } else {
